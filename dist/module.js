...
var Select = ui_1.LegacyForms.Select;
var sosVersion = [{
  label: 'SOS',
  value: 'sos'
}, {
  label: 'Distributed SOS',
  value: 'dsos'
}];
var ConfigEditor = /*#__PURE__*/function (_react_1$PureComponen) {
  _inherits(ConfigEditor, _react_1$PureComponen);
  ...
  _createClass(ConfigEditor, [{
    ...
    value: function render() {
      ...
      return react_1["default"].createElement(react_1["default"].Fragment, null, react_1["default"].createElement(ui_1.DataSourceHttpSettings, {
        defaultUrl: "http://localhost:8080/grafana/",
        dataSourceConfig: options,
        onChange: onOptionsChange
      }), react_1["default"].createElement("h3", {
        className: "page-heading"
      }, "Sos Details"), react_1["default"].createElement("div", {
        className: "gf-form-group"
      }, react_1["default"].createElement("div", {
        className: "gf-form-inline"
      }, react_1["default"].createElement("div", {
        className: "gf-form"
      }, react_1["default"].createElement(ui_1.InlineFormLabel, {
        className: "width-10",
        tooltip: "The POST method is used by default"
      }, "Sos Version"), react_1["default"].createElement(Select, {
        className: "width-10",
        value: sosVersion.find(function (sosVersion) {
          return sosVersion.value === options.jsonData.sosVersion;
        }),
        options: sosVersion,
        defaultValue: options.jsonData.sosVersion,
        onChange: (0, data_1.onUpdateDatasourceJsonDataOptionSelect)(this.props, 'sosVersion')
      })))));
    }
  }]);
  return ConfigEditor;
...
var tslib_1 = __webpack_require__(/*! tslib */ "../node_modules/tslib/tslib.es6.js");
var defaults_1 = (0, tslib_1.__importDefault)(__webpack_require__(/*! lodash/defaults */ "../node_modules/lodash/defaults.js"));
var react_1 = (0, tslib_1.__importStar)(__webpack_require__(/*! react */ "react"));
var ui_1 = __webpack_require__(/*! @grafana/ui */ "@grafana/ui");
var types_1 = __webpack_require__(/*! ./types */ "./types.ts");
var FormField = ui_1.LegacyForms.FormField;
var QueryEditor = /*#__PURE__*/function (_react_1$PureComponen) {
  _inherits(QueryEditor, _react_1$PureComponen);
  var _super = _createSuper(QueryEditor);
  function QueryEditor(props) {
    var _this;
    _classCallCheck(this, QueryEditor);
    _this = _super.call(this, props);
    _this.onAnalysisChange = function (event) {
      var _this$props = _this.props,
        onChange = _this$props.onChange,
        query = _this$props.query;
      onChange(Object.assign(Object.assign({}, query), {
        analysisModule: event.target.value
      }));
    };
    _this.onContainerChange = function (event) {
    ...
    _this.onFormatChange = function (event) {
    ...
    _this.onTargetChange = function (event) {
  ...
  _createClass(QueryEditor, [{
    key: "render",
    value: function render() {
      var query = (0, defaults_1["default"])(this.props.query, types_1.defaultQuery);
      ...
      return react_1["default"].createElement(react_1["default"].Fragment, null, react_1["default"].createElement("div", {
      ...
      }, "Query Type"), react_1["default"].createElement("select", {
        value: queryType,
        ...
        className: "gf-form-label query-keyword width-8"
      }, "Query Format"), react_1["default"].createElement("select", {
        value: format,
        className: "gf-form-input width-12",
        placeholder: "format",
        onChange: this.onFormatChange
      }, react_1["default"].createElement("option", null, "time_series"), react_1["default"].createElement("option", null, "table"), react_1["default"].createElement("option", null, "heatmap"))), react_1["default"].createElement("div", {
...
var SosDataSource = /*#__PURE__*/function (_data_1$DataSourceApi) {
  ...
  function SosDataSource(instanceSettings, templateSrv) {
    ...
    _this.url = lodash_1["default"].map((_a = instanceSettings.url) === null || _a === void 0 ? void 0 : _a.split(','), function (url) {
      return url.trim();
    });
  ...
  _createClass(SosDataSource, [{
    ...
    value: function buildQueryParameters(options) {
      ...
      var targets = lodash_1["default"].map(options.targets, function (target) {
        return {
          target: _this2.templateSrv.replace(target.target) || null,
          container: _this2.templateSrv.replace(target.container) || null,
          schema: _this2.templateSrv.replace(target.schema) || null,
          query_type: target.queryType || 'metrics',
          filters: _this2.templateSrv.replace(target.filters) || null,
          format: _this2.templateSrv.replace(target.format) || 'time_series',
          analysis_module: _this2.templateSrv.replace(target.analysisModule) || null,
          extra_params: _this2.templateSrv.replace(target.extraParams) || null,
          refId: target.refId,
          hide: target.hide
        };
      });
    ...
    key: "doSosRequest",
    value: function doSosRequest(options) {
      return (0, tslib_1.__awaiter)(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              return _context.abrupt("return", (0, runtime_1.getBackendSrv)().datasourceRequest(options));
            case 1:
            case "end":
    ...
    key: "mapMetricToTextValue",
    value: function mapMetricToTextValue(result) {
      return {
        data: lodash_1["default"].map(result.data, function (d, i) {
          if (d && d.text && d.value) {
            return {
              text: d.text,
              value: d.value
...
exports.SosDataSource = SosDataSource;
...
var data_1 = __webpack_require__(/*! @grafana/data */ "@grafana/data");
var datasource_1 = __webpack_require__(/*! ./datasource */ "./datasource.ts");
var ConfigEditor_1 = __webpack_require__(/*! ./ConfigEditor */ "./ConfigEditor.tsx");
var QueryEditor_1 = __webpack_require__(/*! ./QueryEditor */ "./QueryEditor.tsx");
exports.plugin = new data_1.DataSourcePlugin(datasource_1.SosDataSource).setConfigEditor(ConfigEditor_1.ConfigEditor).setQueryEditor(QueryEditor_1.QueryEditor);
