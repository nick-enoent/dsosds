...
var ConfigEditor = function (_super) {
  ...
  ConfigEditor.prototype.render = function () {
    ...
    return react_1["default"].createElement(react_1["default"].Fragment, null, react_1["default"].createElement(ui_1.DataSourceHttpSettings, {
      ...
      onChange: data_1.onUpdateDatasourceJsonDataOptionSelect(this.props, 'sosVersion')
    })))));
  };
...
var defaults_1 = tslib_1.__importDefault(__webpack_require__(/*! lodash/defaults */ "../node_modules/lodash/defaults.js"));
...
var SosDataSource = function (_super) {
  ...
  SosDataSource.prototype.buildQueryParameters = function (options) {
    var _this = this;
  ...
  SosDataSource.prototype.doSosRequest = function (options) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
      return tslib_1.__generator(this, function (_a) {
        // use datasourceRequest rather than fetch for backwards compatability
        return [2
        /*return*/
        , runtime_1.getBackendSrv().datasourceRequest(options)];
      });
    });
  }; // Code to map template variable query response


  SosDataSource.prototype.mapMetricToTextValue = function (result) {
    return {
  ...
  SosDataSource.prototype.query = function (options) {
    return tslib_1.__awaiter(this, void 0, Promise, function () {
      ...
      return tslib_1.__generator(this, function (_a) {
        ...
        return [2
        /*return*/
        , this.doSosRequest(req_opts)];
      });
    });
  };

  SosDataSource.prototype.testDatasource = function () {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
      var options;
      return tslib_1.__generator(this, function (_a) {
        options = {
        ...
        return [2
        /*return*/
        , this.doSosRequest(options).then(function (response) {
